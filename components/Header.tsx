...
export const Header: React.FC<HeaderProps> = ({ totalScore, onLogoClick }) => {
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-slate-900/80 backdrop-blur-md border-b border-slate-800 px-6 py-4 flex items-center justify-between">
      <div
        ...
        onClick={onLogoClick}
      >
        <div className="bg-blue-600 p-2 rounded-lg shadow-lg shadow-blue-500/20 group-hover:bg-blue-500 transition-colors">
